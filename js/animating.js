...
"use strict";
    ...
    function init(options) {
        ...
        $('body').append('<div id="page-ajax-loaded" class="page-ajax-loaded animated animated-section-moveFromTop"></div>');
        ajaxLoader();
    ...
    function ajaxLoader() {
        ...
        function showContent() {
            ajaxLoadedContent.removeClass('animated-section-movetoLeft closed');
            ajaxLoadedContent.show();
            $('body').addClass('ajax-page-visible');
        }

        function hideContent() {
            $('#page-ajax-loaded').addClass('animated-section-movetoLeft closed');
